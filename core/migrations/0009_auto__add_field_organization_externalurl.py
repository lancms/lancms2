...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.externalurl'
        db.add_column('core_organization', 'externalurl',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.externalurl'
        db.delete_column('core_organization', 'externalurl')
