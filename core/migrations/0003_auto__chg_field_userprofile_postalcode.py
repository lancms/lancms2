...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_userprofile', 'postalcode', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.postalcode'
        db.alter_column(u'core_userprofile', 'postalcode', self.gf('django.db.models.fields.IntegerField')(null=True))
