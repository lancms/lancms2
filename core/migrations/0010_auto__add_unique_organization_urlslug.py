...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Organization', fields ['urlslug']
        db.create_unique('core_organization', ['urlslug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Organization', fields ['urlslug']
        db.delete_unique('core_organization', ['urlslug'])
    ...
    models = {
        ...
        'core.organization': {
            ...
            'urlslug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
        },
        'core.userprofile': {
