...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.urlslug'
        db.add_column('core_organization', 'urlslug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, default='nuxis'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.urlslug'
        db.delete_column('core_organization', 'urlslug')
    ...
    models = {
        ...
        'core.organization': {
            ...
            'urlslug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        'core.userprofile': {
